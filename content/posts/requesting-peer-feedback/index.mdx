...
Gather and share feedback from your direct report’s peers. Celebrate with them what others see as their accomplishments and work together to improve in areas others think they can improve.
...
(#spoilers You would only have the `Report`s and `Requestee`s populated at this point. I’ll touch on the right two columns in a moment)
...
As feedback comes in, I move the feedback from the emails into the spreadsheet:
![Peer Feedback Sheet](peer-feedback-sheet.png)
(Now the right two columns will start being populated)
...
The response rate for the follow up has been historically less than the initial feedback response. I usually only push on those requestees that had mentioned areas of development they had mentioned and the report has actively been working on to improve.
