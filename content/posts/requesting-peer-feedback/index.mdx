...
As an engineering manager I feel it is important to facilitate the collection of peer feedback when I do "reviews" with my direct reports. I of course encourage peer-to-peer feedback, but this is an opportunity for others to receive recognition and feedback from others through their manager that we can discuss and work on together. 
...
I then allocate roughly 3-4 members of that pool to each report (keeping in mind that I want to be sure that they actually interact with one another). When allocating, I make sure that I don’t request feedback from someone for more than 3 reports. I don’t want to burden the requestee with a lot of work. This could lead to poor quality feedback or, worse, no feedback at all (or more worse, conflict). 

I manage all of this in a spreadsheet.

After I have the requestees, I then populate my email template for each report.

Subject: `Request for Peer Feedback`
...
As feedback comes in, I move the feedback from the emails into a spreadsheet.
...
**TODO** For some I recommend they give specific feedback directly to the individual. It is important to have a culture of direct, constructive, and timely feedback between team members.

**Follow up with Requestees**

About a month and a half after discussing feedback, I reach back out to the requestees to follow up on the prior feedback they had provided:
```
...
The response rate for the follow up has been historically less than the feedback response. I usually only push on those requestees that had mentioned areas of development they had mentioned and the report has actively been working on to improve.
