...
REPLs and runners can be an easier and quick way to iterate and execute code. Apply the same Rust example with a Cargo package and different Rust REPLS & Runners to see the differences between each tool.
